...
void CrearLetrasyFiguras()
{
	...
	meshColorList.push_back(letras);// indice 0 en el meshColor
	...
	meshColorList.push_back(triangulorojo);// indice 1 en el meshColor

	//TRIÁNGULO AZUL
	//Copiamos el codigo del triángulo rojo cambiando el rgb para que sea azul
	...
	meshColorList.push_back(trianguloazul);// indice 2 en el meshColor

	//TRIÁNGULO VERDE
	//Copiamos el codigo del triángulo rojo cambiando el rgb para que sea verde dado el que se nos dio
	...
	meshColorList.push_back(trianguloverde);// indice 3 en el meshColor
	...
	meshColorList.push_back(cuadradoverde);// indice 4 en el meshColor
	...
	meshColorList.push_back(cuadradocafe);// indice 6 en el meshColor
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//principal es de 1 y lo demas 0
		model = glm::translate(model, glm::vec3(0.0f, 0.65f, -4.0f));//Se translada la matriz model
		//es decir el objeto se translada a otro lado dependiendo de las coordenadas del vector
