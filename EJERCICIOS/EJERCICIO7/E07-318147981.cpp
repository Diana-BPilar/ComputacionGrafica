	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		*/
		...
		//Modificacion del translate anterior uitlizando PosCarro
		model = glm::translate(model, PosCarro);
		/*Vector con la posición del carro que da el usuario más la traslacion de
		la luz para que este en el faro izquierdo*/
		glm::vec3 PosLuz = PosCarro + glm::vec3(-6.0f, 0.0f, 2.8f);
